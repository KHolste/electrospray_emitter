...
| [21_moving_mesh_plan.md](21_moving_mesh_plan.md) | Bewegliches Netz: was das P3b-Netz ist (feste Topologie, bewegliche Knoten), wozu es sich bewegt (statisches Gleichgewicht, keine Zeitentwicklung), was P4 beisteuert (nur Kinematik auf vorgeschriebenem Feld), und was vor einer Taylor-Cone-Aussage konvergiert sein muss. **Planungsdokument — nichts davon implementiert** |
